...
from library.plot_accuracy_sensitivity_specificity import plot_acc_TPR_TNR_together
...
# ============================================================================
""" Load acc_versus_alpha, TPR_versus_alpha, TNR_versus_alpha """
alpha_list = [0.1*i for i in range(11)]

acc_list = np.load(cur_path + '/results/' + folder_name
                   + '/acc_versus_alpha.npy')

TPR_list = np.load(cur_path + '/results/' + folder_name
                   + '/TPR_versus_alpha.npy')

TNR_list = np.load(cur_path + '/results/' + folder_name
                   + '/TNR_versus_alpha.npy')

plt.figure(5)
plot_acc_TPR_TNR_together(alpha_list, acc_list, TPR_list, TNR_list)
